Pod::Spec.new do |s|
  ...
  s.authors   = { 'frank' => 'hello@samvermette.com', 'Tobias Totzek' => 'tobias@totzek.me' }
  s.source   = { :git => 'https://github.com/SVProgressHUD/SVProgressHUD.git', :tag => 2.3.1_xcprivacy_changeFromIOS12toIOS11}
